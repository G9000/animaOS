...
- `IL-010` - Ambient dream-sharing consumer (`done` 2026-08-02, PR #130 merged as `8d49172`, depends on `IL-007`, `IL-008`): filed from IL-008 review round 10 when the Ambient option was withdrawn pending a real consumer; the greeting weave now consumes the mode and the selector offers Ambient again.
