...
- 2026-07-12 - Implemented (Claude session):
  ...
  - **Recorded numbers** (deterministic stub, 30 queries, after Codex-review fixes incl. section-title indexing): dense recall@5 0.8667 / recall@15 1.0 / nDCG@10 0.82; hybrid recall@5 **0.9** / recall@15 1.0 / nDCG@10 **0.8262**; hybrid+template-blurbs recall@5 0.9 / nDCG@10 0.8097. Acceptance holds: hybrid ≥ dense (section-title indexing lifted both arms: hybrid recall@5 0.8667 → 0.9). Blurb/rerank quality claims require the real-embedding mode (stub-mode blurbs use deterministic templates and rerank is skipped) — those runs remain open before flipping either flag on by default.
