...
pub use converter::{
    ...
    MAX_MESSAGE_SEGMENT_BYTES, MAX_THREAD_DOCUMENT_BYTES, MAX_WRITING_ATTACHMENT_BYTES,
    MAX_WRITING_BODY_CHARS, MAX_WRITING_DOCUMENT_BYTES,
};
...
pub struct PreparationStatusV1 {
    ...
    pub expected_validation_generation: Option<u64>,
    pub expected_validation_catalog_sha256: Option<String>,
    pub intended_validation_generation: Option<u64>,
    pub intended_validation_catalog_sha256: Option<String>,
...
fn preparation_status_v1(status: preparation::PreparationStatus) -> PreparationStatusV1 {
    PreparationStatusV1 {
        ...
        expected_validation_generation: status.expected_validation_generation,
        expected_validation_catalog_sha256: status.expected_validation_catalog_sha256,
        intended_validation_generation: status.intended_validation_generation,
        intended_validation_catalog_sha256: status.intended_validation_catalog_sha256,
