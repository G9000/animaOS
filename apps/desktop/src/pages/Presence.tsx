...
const DREAM_SHARING_OPTIONS = [
  ...
  // IL-010: the greeting path consumes this mode server-side
  // (proactive._resolve_ambient_dream) — a share-worthy dream may be woven
  // into a greeting once, then it is marked surfaced.
