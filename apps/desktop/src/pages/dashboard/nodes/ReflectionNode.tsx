  ...
  return (
    <div className="group relative w-72 overflow-visible">
      ...
      <div className={cn(glassPanel, "overflow-hidden")}>
        ...
        {/* Header */}
        <div className="flex items-center justify-between px-3.5 h-9 border-b border-hairline-faint">
          <span className="font-mono text-micro tracking-caps-5 uppercase text-foreground/30">
            Reflection
          </span>
          {isMemory && reflection?.sourceEpisodeDate && (
            <span className="font-mono text-nano tracking-caps-3 uppercase bg-accent/[0.1] text-accent/70 border border-accent/[0.18] px-1.5 py-0.5 rounded-sm">
          ...
          {reflectionLoading ? (
            ...
            <div className="space-y-4 animate-fade-in">
              ...
              <div className="relative pl-4">
                ...
                <p className="text-ui text-foreground/78 leading-relaxed">
                  {reflection.question}
                </p>
              </div>

              <div className="flex items-center justify-between pt-1">
                <span className="font-mono text-[7.5px] tracking-caps-4 uppercase text-foreground/22">
                  from {agentName}
                </span>
                <button
