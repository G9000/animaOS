...
export default function InitiativeOverlay() {
  ...
  return (
    <div className="pointer-events-auto fixed bottom-6 right-6 z-40 w-80 border border-primary/70 bg-card/95 p-4 backdrop-blur">
      <p className="font-mono text-caption uppercase tracking-caps-3 text-muted-foreground/60">
      ...
      <div className="mt-4 flex items-center justify-between gap-3">
        ...
        <div className="flex gap-2">
          <Link
            ...
            className="border border-primary bg-input px-3 py-1.5 font-mono text-caption uppercase tracking-caps-3 text-foreground transition-colors hover:bg-background"
          >
            Reply
          </Link>
          <button
            ...
            className="border border-border px-3 py-1.5 font-mono text-caption uppercase tracking-caps-3 text-muted-foreground transition-colors hover:text-foreground"
          >
            Dismiss
          </button>
        </div>
