...
apps/desktop/src/context/AuthContext.tsx|localStorage.removeItem|"anima_last_user"
apps/desktop/src/context/AuthContext.tsx|localStorage.removeItem|"anima_user"
...
apps/desktop/src/hooks/useBgmPlayer.ts|localStorage.removeItem|DEVICE_BGM_TRACKS_KEY
apps/desktop/src/hooks/useBgmPlayer.ts|localStorage.setItem|DEVICE_BGM_TRACKS_KEY
...
apps/desktop/src/lib/background.ts|localStorage.removeItem|DEVICE_BACKGROUND_MEDIA_KEY
apps/desktop/src/lib/background.ts|localStorage.setItem|DEVICE_BACKGROUND_MEDIA_KEY
apps/desktop/src/lib/daemon.ts|localStorage.removeItem|key
...
apps/desktop/src/lib/portablePreferences.ts|storage.removeItem|item.key
apps/desktop/src/lib/portablePreferences.ts|storage.setItem|key
