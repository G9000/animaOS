...
_BLOCK_POLICIES: dict[str, BlockBudgetPolicy] = {
    ...
    "user_tasks": BlockBudgetPolicy(tier=2, order=4, max_chars=1400),
    "facts": BlockBudgetPolicy(tier=2, order=5, max_chars=1500),
    "preferences": BlockBudgetPolicy(tier=2, order=6, max_chars=1200),
    "self_intentions": BlockBudgetPolicy(tier=2, order=7, max_chars=1000),
