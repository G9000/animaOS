...
The later case-sensitive source-identity and packaged Core/Runtime layout gaps
are also repaired. All ten test-first follow-ups are implemented; Task 3 remains
reopened until refreshed exact-head CI/review, while PCF-004 and PCF-005 remain
dependency-ineligible and unclaimed.
...
- [ ] **Step 8: Add client folder-access settings**
