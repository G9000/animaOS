...
Runtime-index selection, stale-span payload lifecycle, and eval-reset live-vector
eviction gaps. All three test-first follow-ups are implemented; Task 3 remains
